...
<nav class="dp02">
    <div class="nav-wrapper">
        ...
        <ul id="nav-bar" class="right">
            ...
            {#if logged_in}
            <li class="preferences-nav"><button class="dropdown-trigger-preferences" role="button" data-target="preferences-dropdown"><span class="material-symbols-outlined">tune</span></button></li>
